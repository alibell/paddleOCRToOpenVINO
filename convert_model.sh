...
cp $model_path/config.json $model_onnx_path.int8/config.json
uv run compress_model --input_dir $model_onnx_path --output_dir $model_onnx_path.int8 --compression_mode INT8_SYM
